# 
# 
# Param??¨tres g??©n??©raux de la microsimulation
debut        <- 1900
taille_max   <- 75000
nb_enf_max   <- 6 
age_max      <- 108
...
# 
# 
# # Lecture des param??tres simples
# setwd("P:/Retraites/PENSIPP 0.0/Modèle/Paramètres/Destinie/Paramètres Sociaux")
...
# 
# # Param??tres complexes geres par useleg
# AgeMinRG        <- 0
# AgeMinFP        <- 0
# AgeMinFPS       <- 0
# AgeMinFPA       <- 0
